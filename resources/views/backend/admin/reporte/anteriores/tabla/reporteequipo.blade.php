...
<header style="margin-top: 25px; margin-bottom: 25px">
    <div class="row">
        ...
        <div class="content">
            ...
            <p style="text-align: center; font-weight: bold; font-size: 19px">REPORTE DE COMBUSTIBLE <br> Gasolinera METAPAN <br> EQUIPO: {{ $equipo }} <br> DE LINEA: 0101</p>
            <p style="text-align: center; font-weight: bold; font-size: 19px; margin-right: 67px">de {{ $fecha1 }} hasta: {{ $fecha2 }}</p>
        </div>

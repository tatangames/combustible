...
use App\Http\Controllers\Admin\Equipo\ContratoController;
...
// --- CONTRATOS ---
Route::get('/admin/contratos/index', [ContratoController::class,'indexContrato'])->name('admin.contratos.index');
Route::get('/admin/contratos/tabla', [ContratoController::class, 'tablaContrato']);
Route::post('/admin/contratos/nuevo', [ContratoController::class, 'nuevoContrato']);
Route::post('/admin/contratos/informacion', [ContratoController::class, 'informacionContrato']);
Route::post('/admin/contratos/editar', [ContratoController::class, 'editarContrato']);
